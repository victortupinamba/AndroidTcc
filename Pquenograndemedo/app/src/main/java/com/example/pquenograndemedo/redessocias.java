...
public class redessocias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageButton btnInstagram = findViewById(R.id.btnInstagram);
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageButton btnThreads = findViewById(R.id.btnThreads);
        ...
        ImageButton voltar = findViewById(R.id.buttonaaa);
